...
const Home = () => {
    ...
    return (
        <div id="home" className="bg-background text-foreground">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <ul className="space-y-4 text-left">
                            <li className="flex items-center gap-3">
                                ...
                                <span>5 years of professional coding and development experience</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Code2 className="w-5 h-5 text-primary" />
                                <span>Skilled in modern front-end technologies and best practices</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Rocket className="w-5 h-5 text-primary" />
                                <span>Driven to deliver fast, polished, and intuitive interfaces</span>
                            </li>
                        </ul>
                    </div>

                    <div className="flex justify-center md:justify-start">
                        <div className="user-avatar scale-140">
                            <Lottie animationData={AboutDev} loop={true} className="w-96 md:w-[500px]" />
                        </div>
                    </div>
                </div>
            </section>

            <section id="tools_technologies" className="py-12 bg-gray-50">
                <div className="mx-auto max-w-6xl px-6">
                    ...
                    <div className="mx-auto max-w-6xl items-center">
                        <div className="relative overflow-hidden">
                            <div className="flex animate-marquee space-x-20 py-6">
                                <img src={HtmlLogo} alt="Html" className="h-12 w-auto" />
                                <img src={CssLogo} alt="Css" className="h-12 w-auto" />
                                <img src={JsLogo} alt="Css" className="h-12 w-auto" />
                                <img src={ReactLogo} alt="React" className="h-12 w-auto" />
                                <img src={VueLogo} alt="Vue" className="h-12 w-auto" />
                                <img src={AngularLogo} alt="Angular" className="h-12 w-auto" />
                                <img src={ShopifyLogo} alt="Shopify" className="h-12 w-auto" />
                                <img src={PhpLogo} alt="PHP" className="h-12 w-auto" />
                                <img src={LaravelLogo} alt="Laravel" className="h-12 w-auto" />
                                <img src={WordpressLogo} alt="WordPress" className="h-12 w-auto" />
                                <img src={TailwindLogo} alt="WordPress" className="h-12 w-auto" />
            ...
            <section id='my_services' className="py-10 bg-white">
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-5 md:px-10">
                        <div className="relative bg-gray-50 p-8 mb-5 rounded-2xl shadow hover:shadow-lg transition cursor-pointer">
                            <span className="absolute -top-6 left-6 text-5xl font-bold text-primary/60">01</span>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2 mt-3">Web Development</h3>
                            <p className="text-gray-600">
                                Building fast, modern, and SEO-friendly websites with clean, scalable code.
                            </p>
                        </div>

                        <div className="relative bg-gray-50 p-8 mb-5 rounded-2xl shadow hover:shadow-lg transition cursor-pointer">
                            <span className="absolute -top-6 left-6 text-5xl font-bold text-primary/60">02</span>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2 mt-3">UI/UX Implementation</h3>
                            <p className="text-gray-600">
                                Converting Figma/Sketch designs into pixel-perfect, responsive, and user-friendly interfaces.
                            </p>
                        </div>

                        <div className="relative bg-gray-50 p-8 mb-5 rounded-2xl shadow hover:shadow-lg transition cursor-pointer">
                            <span className="absolute -top-6 left-6 text-5xl font-bold text-primary/60">03</span>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2 mt-3">SPA & Dashboards</h3>
                            <p className="text-gray-600">
                                Developing dynamic Single Page Applications and dashboards using React & modern frameworks.
                            </p>
                        </div>

                        <div className="relative bg-gray-50 p-8 mb-5 rounded-2xl shadow hover:shadow-lg transition cursor-pointer">
                            <span className="absolute -top-6 left-6 text-5xl font-bold text-primary/60">04</span>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2 mt-3">Performance Optimization</h3>
                            <p className="text-gray-600">
                                Speed optimization, Core Web Vitals improvements, and smooth cross-browser experiences.
                            </p>
                        </div>

                        <div className="relative bg-gray-50 p-8 mb-5 rounded-2xl shadow hover:shadow-lg transition cursor-pointer">
                            <span className="absolute -top-6 left-6 text-5xl font-bold text-primary/60">05</span>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2 mt-3">API Integration</h3>
                            <p className="text-gray-600">
                                Connecting applications with REST/GraphQL APIs for real-time data and smooth functionality.
                            </p>
                        </div>

                        <div className="relative bg-gray-50 p-8 mb-5 rounded-2xl shadow hover:shadow-lg transition cursor-pointer">
                            <span className="absolute -top-6 left-6 text-5xl font-bold text-primary/60">06</span>
                            <h3 className="text-xl font-semibold text-gray-900 mb-2 mt-3">RTL & Multilingual</h3>
                            <p className="text-gray-600">
                                Implementing right-to-left (Arabic/Urdu) and multilingual website support for global reach.
                            </p>
                        </div>
            ...
            <section id='how_banner' className="relative bg-cover bg-center bg-no-repeat py-20" style={{ backgroundImage: `url(${cover1})` }}>
                <div className="absolute inset-0 bg-primary/70"></div>

                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-primary-foreground">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="#contact">
                            <Button
                                size="lg"
                                variant="secondary"
                                className="rounded-full shadow-lg px-8 py-4"
                            >
                                Hire Me
                            </Button>
                        </a>
            ...
            <section id="contact" className="border-t py-16">
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-12">
                        <h2 className="inline-block text-3xl font-heading font-bold">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:rehmanqayyoum1@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">rehmanqayyoum1@gmail.com</a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+923014022328" className="text-muted-foreground hover:text-primary transition-colors">+92 301 4022328</a>
                                    </div>
                                </div>
            ...
            <footer id='footer' className="bg-gray-900 py-4">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 text-sm text-gray-400">
                    <p className="mt-2 md:mt-0 font-medium">Clean Code · Elegant UI · Seamless User Experience</p>
                    <p className='font-medium'>© {new Date().getFullYear()} Abdul Rehman. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    )
